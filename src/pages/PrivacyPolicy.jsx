  ...
  >
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-lg text-gray-700 mb-6 leading-relaxed">
        Welcome to <strong className="text-indigo-600">BLaban</strong>! Your privacy is of utmost importance to us. This Privacy Policy outlines the types of information we do and do not collect, how we use it, and the measures we take to protect your privacy.
      </p>
      
      <h2 className="text-3xl font-semibold mb-4 text-gray-800">1. Information We Do Not Collect</h2>
      <p className="text-lg text-gray-700 mb-4 leading-relaxed">
        <strong>BLaban</strong> is designed solely for educational purposes. We do not collect, store, or process any personal data from our users. This includes, but is not limited to:
      </p>
      ...
      <p className="text-lg text-gray-700 mb-4 leading-relaxed">
        <strong>BLaban</strong> does not use cookies or any other tracking technologies to monitor or store your activity.
      </p>
