  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="product:price:currency" content="EGP" />
              ...
              <div className="lg:w-1/2 p-6 flex flex-col justify-between">
                <div className="flex flex-col">
                  ...
                  <div className="mb-5 flex items-center">
                    <span className="text-3xl font-bold text-blue-600">{formatPrice(product.price)} EGP</span>
                    {product.mrp > product.price && (
                      <>
                        <span className="ml-4 text-xl text-gray-500 line-through">
                          {formatPrice(product.mrp)} EGP
                        </span>
                        {discountPercentage && (
                  ...
                  <div className="mb-4 space-y-3 bg-gray-50 p-3 rounded-lg">
                    <div className="flex items-center text-gray-700">
                      ...
                      <span>Free shipping on orders over 1,000 EGP across Egypt</span>
                    </div>
                    <div className="flex items-center text-gray-700">
                      ...
                      <div className="p-4 flex flex-col flex-grow">
                        ...
                        <div className="flex items-baseline mb-4">
                          <span className="text-xl font-bold text-blue-600">
                            {formatPrice(similarProduct.price)} EGP
                          </span>
                          {similarProduct.mrp > similarProduct.price && (
                            <span className="ml-2 text-sm text-gray-500 line-through">
                              {formatPrice(similarProduct.mrp)} EGP
                            </span>
                          )}
                        </div>
