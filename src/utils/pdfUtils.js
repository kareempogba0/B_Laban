...
// Import shop logo
import logoImage from '../assets/b-laban-logo.png';
...
export const createReceiptTemplate = (order, containerId) => {
  ...
  const formatDate = (dateString) => {
    ...
    return new Date(dateString).toLocaleDateString('en-EG', options);
  };
    ...
    ">
      ...
      ">
        ...
        <div class="brand-section" style="
          ...
          gap: 14px;
        ">
          <img src="${logoImage}" alt="BLaban Logo" style="
            width: 52px;
            height: 52px;
            border-radius: 10px;
      ...
      ">
        ...
        ">
          ...
          ">From</h3>
          <div style="color: #1d1d1f; font-size: 11px; line-height: 1.5;">
            <div style="font-weight: 600; margin-bottom: 4px;">BLaban Stationeries Pvt. Ltd.</div>
            <div style="color: #86868b; margin-bottom: 2px;">North Sentinel Island, Andaman and Nicobar Islands, Egypt</div>
            <div style="color: #86868b; margin-bottom: 2px;">support@kimo.nsi</div>
            <div style="color: #86868b;">+20 123456789</div>
          </div>
        </div>
      </div>
      ...
      ">
        <h3 style="
          ...
          margin: 0 0 8px 0;
          letter-spacing: -0.2px;
        ">Thank you for your order at BLaban!</h3>
        <p style="
          font-size: 10px;
          color: #86868b;
          margin: 0;
...
export const downloadOrderReceipt = async (order) => {
  try {
    ...
    await generatePdfFromElement('temp-receipt-container', `K-Invoice-${order.orderId}`);
