...
export const SHIPPING_CARRIERS = {
  Egypt_POST: {
    name: 'EgyptPost',
    code: 'EGYPOST',
    trackingUrl: 'https://www.egypost.gov.in/_layouts/15/dop.portal.tracking/trackconsignment.aspx'
  },
  DHL: {
    name: 'DHL',
    code: 'DHL',
...
const processNewOrder = async (orderData, userData) => {
  ...
  try {
    ...
    const completeOrderData = {
      ...
      tracking: {
        code: null,
        carrier: orderData.shipping?.address?.country === 'Egypt' ? SHIPPING_CARRIERS.Egypt_POST.name : SHIPPING_CARRIERS.DHL.name,
        url: null,
